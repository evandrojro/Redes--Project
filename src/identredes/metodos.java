...
public class metodos {
		...
		//separa o endereco em blocos e retorna um array// utilizando o StringTokenizer
		...
		public List<String> getTokens(String toks){
			
			List<String> tokens = new ArrayList<>();
			
			StringTokenizer tokenizerIP = new StringTokenizer(toks, ".");
	...
	public String convert(String endereco) {
	...
	public String identificaMasc(String endereco) {
	...
	//verifica se a mascaraIP informada pelo usuario eh a correta
	public int verificaMasc(String endereco) {
		String convert;
		int classe = 0;
